describe('gb-equipment', function () {
  ...
  function getEquipmentIdsFromIdOrChildren(id, equipmentChildren) {
    return equipmentChildren.length === 0 ? [id]
        : equipmentChildren.map( function( child) { return child.id })
  }
    ...
    module( function ($provide) {
      ...
      $provide.value('$stateParams', {
        ...
        navigationElement: {
          ...
          equipmentIds: getEquipmentIdsFromIdOrChildren( equipmentId, equipmentChildren)
        },
      });
    });
